  ...
  return (
    <div className="p-4 pt-20 max-w-3xl mx-auto bg-[var(--background)] min-h-screen">
      ...
      <div className="flex items-center justify-center w-full h-80 rounded-md relative overflow-hidden bg-[var(--colors-gray1)] border border-[var(--colors-gray6)]">
        ...
        <button className="hold-to-delete-button text-[var(--colors-gray12)] text-lg px-4 py-4 gap-3 select-none touch-manipulation rounded-4xl active:scale-[0.99] bg-black/55 backdrop-blur-[4px] outline-none border-none focus-visible:ring-2 focus-visible:ring-[var(--colors-focus)] focus-visible:ring-offset-1">
          <div
