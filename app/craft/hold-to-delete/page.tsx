...
const page = () => {
  return (
    <div className="p-5 pt-20 max-w-3xl mx-auto bg-[var(--background)] min-h-screen">
      ...
      <div className="flex items-center justify-center w-full h-80 rounded-md relative overflow-hidden bg-[var(--colors-gray1)] border border-[var(--colors-gray6)]">
        <button className="button bg-[var(--colors-gray3)] border border-[var(--colors-gray6)] text-[var(--colors-gray12)] text-lg px-4 py-4 gap-3 select-none touch-manipulation rounded-full active:scale-[0.97]">
